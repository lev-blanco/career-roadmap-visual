...
const statusColors = {
  ...
  upcoming: { bg: "bg-slate-100", border: "border-slate-200", text: "text-slate-400", dot: "bg-slate-300" },
};
    ...
    <section id="timeline" className="py-20 bg-slate-50 relative overflow-hidden">
      ...
      <div className="container relative z-10">
        <div className="max-w-xl mb-12">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-3">12-Month Timeline</h2>
          <p className="text-slate-500 leading-relaxed">
            Three phases from foundation to authority. Total investment: ~$1,500–$2,000 USD.
          </p>
        </div>
            ...
            return (
              <div key={phase.id} className="flex items-center">
                ...
                {i < timelinePhases.length - 1 && (
                  <ArrowRight size={14} className="text-slate-300 mx-1 shrink-0" />
                )}
              </div>
            );
          })}
          ...
          {timelinePhases.map((phase, i) => {
            ...
            return (
              <motion.div
                ...
                className={`rounded-xl border ${colors.border} bg-white p-6 relative overflow-hidden`}
              >
                {/* Top accent line */}
