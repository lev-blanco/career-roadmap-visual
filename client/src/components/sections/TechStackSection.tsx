    ...
    <section id="tech" className="py-20 bg-slate-50 dark:bg-slate-900/50">
      <div className="container">
        <div className="max-w-xl mb-12">
          ...
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 dark:text-slate-100 mb-3">Technologies & Tools</h2>
            ...
            >
              ...
              <div className="flex flex-wrap gap-1.5">
                {cat.items.map((item) => (
                  <span
                    key={item}
                    className="font-mono text-[11px] px-2.5 py-1 rounded-md bg-slate-50 dark:bg-slate-900 text-slate-600 dark:text-slate-400 border border-slate-200 dark:border-slate-700 hover:border-teal/30 hover:bg-teal/[0.03] dark:hover:bg-teal/[0.08] transition-colors"
                  >
                    {item}
                  </span>
                ))}
        ...
        <div className="mt-16 pt-8 border-t border-slate-200 dark:border-slate-700 text-center">
          <p className="font-mono text-xs text-slate-400 dark:text-slate-500">
            Total Investment: ~$2,500-$3,500 USD — recoverable within the first month of compensation increase.
          </p>
        </div>
      </div>
    </section>
