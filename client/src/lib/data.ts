...
export const overview = {
  ...
  pillars: [
    ...
    { label: "AI & Security Focus", desc: "Commanding salary premiums via AI-augmented skills & CSSLP" },
    { label: "LinkedIn Engineering", desc: "Algorithmic discovery optimization" },
    { label: "Portfolio Artifacts", desc: "Signal Staff/Principal-level thinking and technical execution" },
...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    effort: "high",
    roi: "THE developer-specific security cert. Highly recognized in US markets.",
    status: "mandatory",
    provider: "isc2",
  },
  // WCAG
  ...
  },
  {
    ...
    studyHours: "60-100 hours (6-10 weeks)",
    effort: "medium",
    roi: "GCP equivalent to AWS Solutions Architect",
    status: "locked",
    provider: "gcp",
  },
];
...
export const timelinePhases: TimelinePhase[] = [
  {
    ...
    items: [
      ...
      "Post 3x/week on LinkedIn & Curate Featured section",
  ...
  },
  {
    ...
    items: [
      ...
      "Complete IBM Generative AI & AI Engineering Certificates",
      ...
      "Launch Substack newsletter & Submit CFPs to React Summit",
    ],
  },
  {
    id: "phase-3",
...
export const actionGroups: ActionGroup[] = [
  {
    ...
    items: [
      ...
      { text: "Pin React Native, TypeScript, AppSec as top 3 LinkedIn skills", done: false },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Earn IAAP CPACC (MANDATORY)", done: false, urgent: true },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Complete Grokking Modern System Design", done: false },
...
export const careerStrategies: Strategy[] = [
  {
    ...
    icon: "target",
    points: [
      "Niche: React Native architecture + AppSec (CSSLP) + WCAG + AI integration",
...
export const techCategories = [
  ...
  { category: "APIs", items: ["OpenAI API", "Anthropic Claude", "Azure Cognitive", "Google Vision"] },
  { category: "Mobile AI", items: ["react-native-executorch", "react-native-fast-tflite", "MLC LLM"] },
  ...
  { category: "Cloud (GCP)", items: ["Cloud Functions", "Vertex AI", "Cloud Run"] },
];
...
export const courses: Course[] = [
  // Original Courses
  {
    ...
    category: "ai",
    description: "Comprehensive course on integrating generative AI into software workflows. Covers prompt engineering and APIs.",
    priority: "high",
    cost: "$49/mo (Coursera)",
    priceNum: 98,
  ...
  },
  {
    ...
    provider: "Udemy",
    category: "mobile",
    description: "Deep dive into React Native development including the New Architecture, TurboModules, and performance.",
    priority: "medium",
    cost: "$15-30",
    priceNum: 25,
    studyHours: "25-35 hours",
    effort: "medium",
  },
  {
    ...
    category: "fullstack",
    description: "Advanced TypeScript patterns for React applications. Strict typing, generics, utility types.",
    priority: "medium",
    cost: "$15-49",
    priceNum: 30,
    studyHours: "15-25 hours",
    effort: "low",
  },
  {
    ...
    description: "Official Deque courses on WCAG compliance, screen reader testing. Directly supports IAAP certification prep.",
    priority: "high",
    cost: "$30/mo",
    priceNum: 90,
    studyHours: "30-50 hours",
    effort: "medium",
  },
  {
    ...
    provider: "Meta",
    category: "mobile",
    description: "Official Meta certification program covering React Native fundamentals through advanced patterns.",
  ...
  },
  {
    ...
    provider: "Google",
    category: "fullstack",
    description: "Foundation for GCP certifications. Covers core infrastructure and cloud-native application development.",
    priority: "recommended",
    cost: "$49/mo",
    priceNum: 98,
    studyHours: "20-30 hours",
    effort: "low",
  },
  // New Courses
  {
    ...
    provider: "Fast.ai",
    category: "ai",
    description: "The gold standard for applied deep learning. Build real models from week 1 covering neural nets, NLP, and vision.",
    priority: "high",
    cost: "$0",
    priceNum: 0,
  ...
  },
  {
    ...
    category: "security",
    description: "Hands-on web app security labs. Covers XSS, SQLi, CSRF, directly relevant to frontend/fullstack.",
    priority: "high",
    cost: "$0",
    priceNum: 0,
    studyHours: "~60 hours",
  ...
  },
  {
    ...
    provider: "IBM",
    category: "ai",
    description: "LLMs, RAG pipelines, LangChain, prompt engineering, agentic AI.",
    priority: "medium",
    cost: "$240/yr (Plus)",
    priceNum: 240,
...
export function getEducationItems(): EducationItem[] {
  ...
  const courseItems: EducationItem[] = courses.map((c) => ({
    ...
    category: c.category === "ai" ? "AI" : c.category === "system-design" ? "System Design" : c.category === "security" ? "Security" : c.category === "mobile" ? "Mobile" : c.category === "accessibility" ? "Accessibility" : "Full-Stack",
  }));
